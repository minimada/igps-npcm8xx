...
BBheader_xml_source = os.path.join(ref_dir, "BootBlockAndHeader_A1_SVB.xml")
BBheader_xml_no_tip_source = os.path.join(ref_dir, "BootBlockAndHeader_A1_SVB_NoTip.xml")
...
try:
	...
	print("--------------------------------------")
	print("Updating input binaries for  Arbel A1 or A2 SVB")
	print("--------------------------------------")
