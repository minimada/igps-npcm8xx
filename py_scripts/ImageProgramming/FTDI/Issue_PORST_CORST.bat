...
Arbel_EVB_Automation -open-desc "NPCM8mnx_Evaluation_Board A" %PORST_ASSERTED% %STRAP5_ASSERTED% -update -delay 10 %CORST_RELEASE% -update -delay 100
Arbel_EVB_Automation -open-desc "NPCM8mnx_Evaluation_Board A" %PORST_ASSERTED% %STRAP5_ASSERTED% -update -delay 100 %PORST_RELEASE% -update -delay 100 %CORST_ASSERTED% -update -delay 100
