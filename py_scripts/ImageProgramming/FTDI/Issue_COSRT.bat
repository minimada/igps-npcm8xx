...
rem Arbel_EVB_Util -help
rem Arbel_EVB_Util -list


:: if one Arbel EVB is connected, -open-desc command can be use. 
Arbel_EVB_Automation -open-desc "NPCM8mnx_Evaluation_Board A" %CORST_ASSERTED% -update -delay 100 %CORST_RELEASE% -update -delay 100
Funtion returned: %ERRORLEVEL%
